...
class OCRProcessor:
    ...
    def extract_text_from_base64_image(self, base64_image):
        """Analyzes a document from a base64 image using the prebuilt-read model.

        Args:
            base64_image: The base64 image data.
